...
namespace EmailServiceHorse
{
    public partial class HorseService : ServiceBase
    {
        public HorseService()
        {
            InitializeComponent();
        ...
        private void SchedularCallback(object e)
        {
            try
            {
                ...
                string constr = ConfigurationManager.ConnectionStrings["HorseConnection"].ConnectionString;
